...
ActiveRecord::Schema.define(version: 20_210_312_144_835) do
  create_table 'active_admin_comments', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                        force: :cascade do |t|
    t.string 'namespace'
    t.text 'body'
  ...
  create_table 'follows', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                          force: :cascade do |t|
  ...
  create_table 'friendly_id_slugs', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                    force: :cascade do |t|
  ...
  create_table 'mailboxer_conversation_opt_outs', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                                  force: :cascade do |t|
  ...
  create_table 'mailboxer_conversations', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                          force: :cascade do |t|
  ...
  create_table 'mailboxer_notifications', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                          force: :cascade do |t|
    t.string 'type'
    t.text 'body'
    t.string 'subject', default: ''
  ...
  create_table 'mailboxer_receipts', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                                     force: :cascade do |t|
  ...
  create_table 'taggings', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                           force: :cascade do |t|
    t.integer 'tag_id'
  ...
  create_table 'tags', id: :integer, charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci',
                       force: :cascade do |t|
